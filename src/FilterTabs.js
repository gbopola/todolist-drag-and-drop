  ...
  return (
    <FilterTab>
      <div className="items-left">
        <p>
          {todoLength()} item{returnValue !== 1 && 's'} left
        </p>
      </div>
      <div className="items-middle">
        <p onClick={activeTab} id={currTabState === 'All' ? 'all' : ''}>
          All
        </p>
        <p onClick={activeTab} id={currTabState === 'Active' ? 'active' : ''}>
          Active
        </p>
        <p
          onClick={activeTab}
          id={currTabState === 'Completed' ? 'complete' : ''}
        >
          Completed
        </p>
      </div>
